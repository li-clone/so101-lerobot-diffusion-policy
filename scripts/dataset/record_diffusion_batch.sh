...
DATASET_ID="${DATASET_ID:-local/so101_pick_place_compare_v1_70}"
DATASET_ROOT="${DATASET_ROOT:-${DATA_ROOT:-$PWD/data}/so101_pick_place_compare_v1_70}"
NUM_EPISODES="${NUM_EPISODES:-10}"
RESUME="${RESUME:-false}"
TASK="${TASK:-Pick up the yellow cable bundle and place it in the black target area.}"
